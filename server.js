...
app.get('/rooster', function(request, response){
  io.emit('rooster', "Rooster crow!");
  response.send('OK');
});

app.get('/dixiehorn', function(request, response){
  io.emit('dixiehorn', "Dixie horn!");
  response.send('OK');
});


app.get('/submarine', function(request, response){
  io.emit('submarine', "Submaribe diving!");
  response.send('OK');
});

app.get('/baby', function(request, response){
  io.emit('baby', "Baby crying!");
  response.send('OK');
});
